...
% Project 1 - Golden Section Method
...
for i = 1 : length(f)
    ...
    counter = plotCounter;
    for l = l_val
        [a,b,k(end+1)] = goldenSectionMethod(f{i},l,a_init,b_init);
        
        
        % Plot [a,b](k)
        figure(counter)
        sgtitle('Golden Section Method (Intervals)')
    ...
    sgtitle(' Golden Section Method (Accuracy)')
    subplot(3,1,i)
    plot(l_val,k ,'-x')
